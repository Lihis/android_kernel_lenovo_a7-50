...
CUSTOM_HAL_IMGSENSOR=a5142_mipi_raw hi257_yuv gc2235_raw
...
CUSTOM_HAL_SUB_BACKUP_IMGSENSOR=gc2235_raw
...
CUSTOM_KERNEL_IMGSENSOR=a5142_mipi_raw hi257_yuv gc2235_raw
...
CUSTOM_KERNEL_SUB_BACKUP_IMGSENSOR=gc2235_raw
...
CUSTOM_LK_LCM=CPT_CLAA070WP0B_HIMAX AUO_B070EAN014_HIMAX
...
MTK_PRODUCT_AAPT_CONFIG=ldpi hdpi mdpi xhdpi
...
MTK_RELEASE_PACKAGE=rel_customer_basic rel_customer_platform rel_customer_tablet
...
CUSTOM_MODEM=lcsh82_tb_3gfull_kk_hspa
...
CUSTOM_KERNEL_LCM=CPT_CLAA070WP0B_HIMAX AUO_B070EAN014_HIMAX

# To choose uboot LCM driver name
CUSTOM_UBOOT_LCM=CPT_CLAA070WP0B_HIMAX AUO_B070EAN014_HIMAX
...
MTK_PRODUCT_LOCALES=en_US fr_FR it_IT es_ES de_DE nl_NL cs_CZ pl_PL ja_JP zh_TW zh_CN ru_RU ko_KR nb_NO es_US da_DK el_GR tr_TR pt_PT pt_BR rm_CH sv_SE bg_BG ca_ES en_GB fi_FI hi_IN hr_HR hu_HU in_ID iw_IL lt_LT lv_LV ro_RO sk_SK sl_SI sr_RS uk_UA vi_VN tl_PH ar_EG fa_IR th_TH sw_TZ ms_MY af_ZA zu_ZA am_ET hi_IN de_AT de_CH fr_BE en_US en_AU en_CA en_IN en_NZ en_SG en_ZA ar_IL nl_BE et_EE
...
#CREATE_PROJECT_INFO=2014021913546
MTK_BUILD_VERNO = ALPS.KK1.MP1.V2.10

MTK_ASF_PLAYBACK_SUPPORT =no

SLT_DRV_CUSTOMIZE=SLT_DRV_P3550_CONFIG	#This feature is controlled by driver for Project privatization

# ADD For detail info in *#87#
SLT_DEVINFO_KERNEL_SUPPORT = yes
SLT_DEVINFO_SUPPORT = SLT_DEVINFO_LCM SLT_DEVINFO_CMM SLT_DEVINFO_CTP SLT_DEVINFO_EMCP

# ALSPS sensor driverto detect ambint light and the object is close or far awary from device
CUSTOM_KERNEL_CAPTOUCH=iqs128
MMI_CAPTOUCH_SUPPORT = yes

ALLOW_LOCAL_PROP_OVERRIDE=yes

LCT_AUTO_TEST=yes
LCT_PROJECT_LXF_P3550=yes
LCT_PROJECT_LXF_P3550_B04=yes
# connect vibrate
LCT_CONNECT_VIBRATE_SUPPORT=yes

#GMS
GOOGLE_SERVICES_SUPPORT=yes

#CE test
LCT_FOR_CE_TEST = yes

#IP_CALL
LXF_IP_CALL_SUPPORT=yes

#add for running test
LCT_RUNINTEST_APP=yes 

#shutdown when battery is zero
LXF_LOWBATTERY_SHUTDOWN_30S=yes

# for multi_local one image, local id control the local information
LCT_COUNTRY_INFO_CONTROL=yes

#add for third party apk
LCT_PROJECT_LXF_P3550_ThirdParty_ROW=yes
LCT_PROJECT_LXF_P3550_ThirdParty_PRC=no

#ideafriend
LCT_PROJECT_LXF_P3550_IdeaFriend_PRC=no

#for reliability test
LXF_RELIABILITY_TEST=no

#add for number min match
LCT_NUMBER_MIN_MATCH_11 = no

#lenovo smart bar support
LXF_SMARTBAR_SUPPORT=yes 
#install app to sdcard(only set one of 'MTK_2SDCARD_SWAP' and 'LCT_APP_2SDCARD' 'yes')
LCT_APP_2SDCARD=yes
