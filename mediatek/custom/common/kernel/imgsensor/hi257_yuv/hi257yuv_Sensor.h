...
#define HI257_PV_PERIOD_PIXEL_NUMS      (824)    /* Default preview line length */
#define HI257_PV_PERIOD_LINE_NUMS       (632)     /* Default preview frame length */
#define HI257_FULL_PERIOD_PIXEL_NUMS    (1640)    /* Default full size line length */
#define HI257_FULL_PERIOD_LINE_NUMS     (1248)    /* Default full size frame length */
