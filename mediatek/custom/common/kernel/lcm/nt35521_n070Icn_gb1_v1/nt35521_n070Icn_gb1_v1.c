...
static void init_lcm_registers(void)
{
    ...
    /* 0xC8, 0x00 */
    data_array[0] = 0x00C81500;    /* disable screen black when hsync timeout */
    dsi_set_cmdq(&data_array,1,1);

    /* 0xB1 0x60, 0x01 */
    data_array[0] = 0x00033902;
    data_array[1] = 0x000160B1;   /* disable eotp */
    dsi_set_cmdq(data_array, 2, 1);
...
if ( 0  != hw_id ) { 
    ...
    dsi_set_cmdq(data_array, 3, 1);
#if 1
    /* more power save for ui mode and adjust BRTCBUI . */
    /*PAGE0 0xE6 0xF3, 0xCC, 0xB3, 0x95 */
    data_array[0] = 0x00053902;
    data_array[1] = 0xB3CCF3E6; 
    data_array[2] = 0x00000095;
    dsi_set_cmdq(data_array, 3, 1);
#endif 
    /* 0xE7,0xFF, 0xF7, 0xEF, 0xE7, 0xDF, 0xD7, 0xCF, 0xC7, 0xBF, 0xB7 */
/*
    data_array[0] = 0x000B3902;
    data_array[1] = 0xEFF7FFE7; 
    data_array[2] = 0xCFD7DFE7;
    data_array[3] = 0x00B7BFC7;
...
static void lcm_setbacklight_mode(unsigned int mode)
{
	...
	printk("%s, %d\n", __func__, mode);
#endif 
	data_array[0] = (0x00551500 | (mode <<24));
	dsi_set_cmdq(&data_array, 1, 1);
}
#endif /* */
