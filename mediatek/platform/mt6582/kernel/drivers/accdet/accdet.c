   ...
   //KE under fastly plug in and plug out
    ...
    if (cur_eint_state == EINT_PIN_PLUG_IN) {
		...
		ACCDET_DEBUG("ACCDET use in 2.8V mode!! \n");
			...
			cust_i2c_write_byte(0x76, 0x04, 0x01);
			msleep(500);
			cust_i2c_read_byte(0x76, 0x02, &ts3a225e_reg_value[1]);
			cust_i2c_read_byte(0x76, 0x03, &ts3a225e_reg_value[2]);
			cust_i2c_read_byte(0x76, 0x05, &ts3a225e_reg_value[4]);
			cust_i2c_read_byte(0x76, 0x06, &ts3a225e_reg_value[5]);
			...
			if (ts3a225e_reg_value[5] == 0x01)
			{
				...
				cust_i2c_write_byte(0x76, 0x02, 0x07);
				cust_i2c_write_byte(0x76, 0x03, 0xf3);
				msleep(10);
			}
...
#endif
#if defined(ACCDET_TS3A225E_PIN_SWAP)
	ACCDET_DEBUG("[Accdet] TS3A225E init!\n");
	cust_i2c_read_byte(0x76, 0x01, &ts3a225e_reg_value[0]);
	ACCDET_DEBUG("[Accdet] TS3A225E ID=%x!\n", ts3a225e_reg_value[0]);
#endif
